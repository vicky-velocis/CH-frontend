...
class CGBookingDetails extends Component {
  ...
  render() {
    const { firstName, email, mobileNo, FatherName,completeAddress} = this.props;
return (
      <div>
        <Card
          textChildren={
            <div>
              ...
              <div className="col-md-4">
               ...
               <div className="col-md-4">
                                <Label className="col-xs-12  col-sm-12 col-md-12 status-color" label="BK_CGB_FATHERNAME_LABEL" />
                                <Label
                                    labelStyle={{ color: "inherit" }}
                                    className="col-xs-12  col-sm-12 col-md-12  status-result-color"
                                    id="complaint-details-complaint-number"
                            ...
                            <div className="col-md-4">
                                <Label className="col-xs-12  col-sm-12 col-md-12 status-color" label="BK_CGB_COMPLETE_ADDRESS_LABEL" />
                                <Label
                                    className="col-xs-12  col-sm-12 col-md-12  status-result-color"
                                    id="complaint-details-current-status"
                                    labelStyle={{ color: "inherit" }}

...
class InboxData extends React.Component {
  ...
  render() {
    const { data, classes ,columnHideIndex} = this.props;
    const emptyRows =
    ...
    return (
      <div>
        ...
        <Hidden only={["sm", "md", "lg", "xl"]} implementation="css">
          ...
          {console.log(data, "tabledata") && data.rows.length === 0 ? (
                          ...
                          <React.Fragment> 
                            ...
                            <CardContent style={{ padding: "0px" }}>
                              ...
                              >
                                ...
                                <IconButton  style={{position: 'relative', left: '-40px',bottom: '17px'}} onClick={()=>this.props.handleEditClick(row)}>
                                  <EditIcon
                                    size="small"
                                    style={{ fontSize: "20px" }}
                                  />

...
class SuccessMessage extends Component {
  render() {
    ...
    let one = "BK_MYBK_PCC_APPLICATION_REQUEST"
    console.log("one--",one)
    let two =  <Label label={"BK_MYBK_PCC_APPLICATION_REQUEST"}/>
    console.log("two--",two)
    console.log("BK_MYBK_PCC_APPLICATION_REQUEST---",<Label label={"BK_MYBK_PCC_APPLICATION_REQUEST"}/>)
...
//     return (
//       <div>
//   <h1><Label label={"BK_MYBK_PCC_APPLICATION_REQUEST"} /></h1>

...
export const callBackForNext = async (state, dispatch) => {
  let activeStep = get(
    state.screenConfiguration.screenConfig["createMaterialReceiptNoteother"],
  ...
  if (activeStep === 0) {
    const isMaterialDetailsValid = validateFields(
      ...
      state,
      dispatch,
      "createMaterialReceiptNoteother"
    );
...
export const changeStep = (
  ...
  dispatchMultipleFieldChangeAction("createMaterialReceiptNoteother", actionDefination, dispatch);
